        ...
        <Container>
            <div className="grid grid-cols-5 gap-14 items-center md:py-20 py-4">
                <div className="col-span-5 lg:col-span-3 md:text-left text-center">
                    <div>
                        <p className=" py-2 px-6 text-sm bg-[#3e6cd728] hidden md:inline-block rounded-full">Junayed Noman</p>
                    </div>
                    ...
                    <div>
                        <a href="#contact" className="inline bg-red-500"><Btn text='Say Hello👋'></Btn></a>
                    </div>
                </div>
            ...
            <div className="text-center lg:-mt-[120px] md:-mt-[80px] mt-5">
                <a href="#techs"><img className="mx-auto scrollDownImg w-[40px] inline-block" src={moveIcon} alt="" /></a><br />
                <a href="#techs" className='lg:mb-14 md:mb-10 mb-2 inline-block'>Scroll Down</a>
            </div>
        </Container>
