...
const Cta = () => {
    return (
        <Container>
            <div className="md:p-10 p-5 bg-[#3e6cd7bb] rounded-md lg:flex-row flex-col flex items-center gap-4 md:gap-8 md:mb-0 mb-5">
                <div>
                ...
                <div className="lg:w-[60%] w-full lg:text-right text-left">
