            ...
            <Container>
                <footer className="footer items-center justify-between gap-6">
                    <aside className="items-center grid-flow-col">
                        <p className="text-gray-600 md:text-left text-center">Copyright © {new Date().getFullYear()} - All right reserved by <span className="font-semibold text-[#09426F]">Junayed Noman</span></p>
                    </aside>
                    <div className="flex gap-3 w-full justify-center">
                        <a href="https://www.linkedin.com/in/junayed-noman/" target="_blank" className="hover:scale-110 w-[32px] duration-200"><img className="w-full" src={linkedinImg} alt="" /></a>
